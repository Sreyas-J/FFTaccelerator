...
#
# Script generated by Vivado on Sun Jun 07 18:35:19 IST 2026
...
#
# Usage        : BUFF1A.sh
#                BUFF1A.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                BUFF1A.sh [-reset_run]
#                BUFF1A.sh [-reset_log]
#                BUFF1A.sh [-help]
#
...
#                script (type 'BUFF1A.sh -help' for more information).
#
...
# script info
echo -e "BUFF1A.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./BUFF1A.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.BUFF1A xil_defaultlib.glbl -o BUFF1A_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./BUFF1A_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key BUFF1A_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc BUFF1A_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./BUFF1A.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: BUFF1A.sh [-help]\n\
Usage: BUFF1A.sh [-step]\n\
Usage: BUFF1A.sh [-lib_map_path]\n\
Usage: BUFF1A.sh [-reset_run]\n\
Usage: BUFF1A.sh [-reset_log]\n\
Usage: BUFF1A.sh [-keep_index]\n\
Usage: BUFF1A.sh [-noclean_files]\n\n\
