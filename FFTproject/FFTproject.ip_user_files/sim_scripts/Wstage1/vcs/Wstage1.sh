...
#
# Script generated by Vivado on Sat Jun 06 15:32:22 IST 2026
...
#
# Usage        : Wstage1.sh
#                Wstage1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Wstage1.sh [-reset_run]
#                Wstage1.sh [-reset_log]
#                Wstage1.sh [-help]
#
...
#                script (type 'Wstage1.sh -help' for more information).
#
...
# script info
echo -e "Wstage1.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Wstage1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.Wstage1 xil_defaultlib.glbl -o Wstage1_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./Wstage1_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/dell/Desktop/projects/20cred/FFTaccelerator/FFTproject/FFTproject.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key Wstage1_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc Wstage1_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Wstage1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Wstage1.sh [-help]\n\
Usage: Wstage1.sh [-step]\n\
Usage: Wstage1.sh [-lib_map_path]\n\
Usage: Wstage1.sh [-reset_run]\n\
Usage: Wstage1.sh [-reset_log]\n\
Usage: Wstage1.sh [-keep_index]\n\
Usage: Wstage1.sh [-noclean_files]\n\n\
